...
public class GanadorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tiempo = findViewById(R.id.ganadortiempo);
        aciertos = findViewById(R.id.ganadoraciertos);
        fallos = findViewById(R.id.ganadorfallos);
        tiempo.setText(t);
        aciertos.setText(a);
        fallos.setText(f);
    }
    ...
    protected void onStart() {
        ...
        btMostrarPartida.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(GanadorActivity.this, ResultadosActivity.class);
                intent.putExtra("list", list);
                intent.putExtra("color", "green2");
        ...
        btMacadorPersonal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    if (mgbool) {
                        Intent intent = new Intent(GanadorActivity.this, MarcadorPersonalActivity.class);
            ...
            public void onClick(View view) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    if (mgbool) {
                        if (i == 0) {
                            i++;
                            Intent intent = new Intent(GanadorActivity.this, MarcadorGlobalActivity.class);
    ...
    public void cargarMarcadorPersonal() {
        if (getIntent().getStringExtra("username") != null) {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            Marcador mp = new Marcador(nombre, aciertos, fallos, tiempo);
                            listaMarcadorPersonal.add(mp);
            ...
            RequestQueue queue = Volley.newRequestQueue(GanadorActivity.this);
    ...
    public void cargarMarcadorGlobal() {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(GanadorActivity.this);
    ...
    private void comprobarconexion() {
        Toast.makeText(getApplicationContext(), "Compruebe si tiene conexión a internet...", Toast.LENGTH_LONG).show();
    }
}